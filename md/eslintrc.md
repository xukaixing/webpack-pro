...
----------------------------------eslint-----------------------------------
  ...
  "eslint.options": {
      "configFile": ".eslintrc.js", //此路径值指向上一步创建的.eslintrc.js文件地址
      // "plugins": ["html","javascript","vue"],
      // "settings": {
      //     "html/html-extensions": [".html", ".vue"]
      // },
      "extensions": [ // 指定vscode的eslint所处理的文件后缀
        ".js",
        ".vue",
        "html"
      ]
...
module.exports = {
  ...
  // 此项是用来提供插件的，插件需要在package.json中依赖，插件名称省略了eslint-plugin-
  plugins: [
    'commonjs',
    // 'vue',
    'prettier',
    'html'],
  // 规则继承：eslint内置推荐规则，就只有一个，即「eslint:recommended」，
